...
//this fxn updates the calculator screen with the contents of Display_Value
function Update_Display() {
    //make use of the calculator-screen class to target the input tag 
